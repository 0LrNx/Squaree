        ...
        <div>
            <div className="flex flex-row justify-center items-center text-dark text-xl font-dmsans font-medium pt-32">
                <div>
                    ...
                    <p className="text-[#626262] text-lg font-manrope text-left pt-6 w-3/4">The expectation that productivity should always lead to tangible results or accomplishments.</p>
                </div>
